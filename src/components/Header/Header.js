...
const Header = ({onClick }) => (
  <div className="header w3-bar w3-top w3-white w3-xlarge">
    ...
    <button className="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-left w3-hover-none w3-hover-text-light-grey">Project</button>
    <button className="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-left w3-hover-none w3-hover-text-light-grey">Add component</button>
  </div>
)
